!(function(e, t) {
  ...
  class r {
    ...
    update() {
      const { coords: t, _hullPrev: r, _hullNext: a, _hullTri: o, _hullHash: l } = this,
        u = t.length >> 1;
      let s = 1 / 0,
        d = 1 / 0,
        h = -1 / 0,
      ...
      (a[v] = r[m] = y),
        ...
        (o[m] = 2),
        l.fill(-1),
        (l[this._hashKey(k, _)] = v),
        (l[this._hashKey(M, x)] = y),
        (l[this._hashKey(S, P)] = m),
        (this.trianglesLen = 0),
        this._addTriangle(v, y, m, -1, -1, -1);
      for (let n, i, c = 0; c < this._ids.length; c++) {
        ...
        let b,
          p = h;
        for (; (b = a[p]), !f(s, d, t[2 * p], t[2 * p + 1], t[2 * b], t[2 * b + 1]); )
          if (((p = b), p === h)) {
            p = -1;
            break;
          }
      ...
      e.exports = (function() {
        ...
        var f = function(e) {
          ...
          d = function() {
            ...
            if (!n) {
              (a = !0),
                c.sorted ||
                  ((c.autodetect = c.autodetect.sort(function(e, t) {
                    return t.p - e.p;
                  })),
                  (c.sorted = !0));
        ...
        var M = i.unpack,
          ...
          A = function() {
            ...
            var f,
              ...
              l = (c + i) / 2;
            return (
              c === i ? ((f = 0), (o = Number.NaN)) : (f = l < 0.5 ? (c - i) / (c + i) : (c - i) / (2 - c - i)),
              r == c ? (o = (n - a) / (c - i)) : n == c ? (o = 2 + (a - r) / (c - i)) : a == c && (o = 4 + (r - n) / (c - i)),
              (o *= 60) < 0 && (o += 360),
              e.length > 3 && void 0 !== e[3] ? [o, f, l, e[3]] : [o, f, l]
            );
          },
          E = i.unpack,
          G = i.last,
          ...
          F = function() {
            ...
            if (0 === i) n = a = f = 255 * c;
              ...
              for (var b = 0; b < 3; b++)
                l[b] < 0 && (l[b] += 1),
                  l[b] > 1 && (l[b] -= 1),
                  6 * l[b] < 1 ? (u[b] = d + 6 * (s - d) * l[b]) : 2 * l[b] < 1 ? (u[b] = s) : 3 * l[b] < 2 ? (u[b] = d + (s - d) * (2 / 3 - l[b]) * 6) : (u[b] = d);
          ...
          $ = function(e) {
            var t;
            if (((e = e.toLowerCase().trim()), c.format.named))
              try {
        ...
        var ce = i.unpack,
          ...
          me = function() {
            ...
            return (
              ...
              f < 0 && (f += 360),
              (f /= 360) < 1 / 3
                ? (n = 1 - ((a = (1 - o) / 3) + (r = (1 + (o * ye(ge * f)) / ye(ve - ge * f)) / 3)))
                : f < 2 / 3
                ? (a = 1 - ((r = (1 - o) / 3) + (n = (1 + (o * ye(ge * (f -= 1 / 3))) / ye(ve - ge * f)) / 3)))
                : (r = 1 - ((n = (1 - o) / 3) + (a = (1 + (o * ye(ge * (f -= 2 / 3))) / ye(ve - ge * f)) / 3))),
              [255 * (r = pe(i * r * 3)), 255 * (n = pe(i * n * 3)), 255 * (a = pe(i * a * 3)), e.length > 3 ? e[3] : 1]
            );
          },
          we = i.unpack,
          ke = i.type;
        ...
        var xe = i.unpack,
          ...
          Pe = function() {
            ...
            return (
              (a = l / 255),
              0 === l ? ((r = Number.NaN), (n = 0)) : ((n = u / l), f === l && (r = (o - i) / u), o === l && (r = 2 + (i - f) / u), i === l && (r = 4 + (f - o) / u), (r *= 60) < 0 && (r += 360)),
              [r, n, a]
            );
          },
          Ae = i.unpack,
        ...
        var je = 18,
          ...
          Ye = function(e, t, r) {
            return (
              ...
              (t = $e(t)),
              (r = $e(r)),
              [De((0.4124564 * e + 0.3575761 * t + 0.1804375 * r) / Be), De((0.2126729 * e + 0.7151522 * t + 0.072175 * r) / Fe), De((0.0193339 * e + 0.119192 * t + 0.9503041 * r) / Te)]
            );
          },
          We = function() {
            for (var e = [], t = arguments.length; t--; ) e[t] = arguments[t];
          ...
          Ke = Math.pow,
          He = function(e) {
            return 255 * (e <= 0.00304 ? 12.92 * e : 1.055 * Ke(e, 1 / 2.4) - 0.055);
          },
          Xe = function(e) {
          ...
          Je = function() {
            ...
            return (
              ...
              (r = Be * Xe(r)),
              (a = Te * Xe(a)),
              [He(3.2404542 * r - 1.5371385 * n - 0.4985314 * a), He(-0.969266 * r + 1.8760108 * n + 0.041556 * a), He(0.0556434 * r - 0.2040259 * n + 1.0572252 * a), e.length > 3 ? e[3] : 1]
            );
          },
          Ze = i.unpack,
          Qe = i.type;
        ...
        var Et = Math.log,
          Gt = function(e) {
            ...
            return (
              a < 66
                ? ((t = 255),
                  (r = -155.25485562709179 - 0.44596950469579133 * (r = a - 2) + 104.49216199393888 * Et(r)),
                  (n = a < 20 ? 0 : 0.8274096064007395 * (n = a - 10) - 254.76935184120902 + 115.67994401066147 * Et(n)))
                : ((t = 351.97690566805693 + 0.114206453784165 * (t = a - 55) - 40.25366309332127 * Et(t)), (r = 325.4494125711974 + 0.07943456536662342 * (r = a - 50) - 28.0852963507957 * Et(r)), (n = 255)),
              [t, r, n, 1]
            );
          },
          Ot = i.unpack,
          ...
          jt = function() {
            for (var e = [], t = arguments.length; t--; ) e[t] = arguments[t];
            for (var r, n = Ot(e, "rgb"), a = n[0], f = n[2], o = 1e3, i = 4e4, c = 0.4; i - o > c; ) {
              var l = Gt((r = 0.5 * (i + o)));
              l[2] / l[0] >= f / a ? (i = r) : (o = r);
            }
            return Rt(r);
        ...
        var Ct = function(e, t, r) {
            return 0.2126 * (e = Lt(e)) + 0.7152 * (t = Lt(t)) + 0.0722 * (r = Lt(r));
          },
          Lt = function(e) {
            return (e /= 255) <= 0.03928 ? e / 12.92 : Tt((e + 0.055) / 1.055, 2.4);
          },
          zt = {},
          It = i.type,
          qt = function(e, t, r) {
        ...
        var Yt = function(e, t, r, n) {
            ...
            return (
              "hsl" === n
                ...
                : "hsi" === n
                ? ((o = e.hsi()), (i = t.hsi()))
                : ("lch" !== n && "hcl" !== n) || ((n = "hcl"), (o = e.hcl()), (i = t.hcl())),
              "h" === n.substr(0, 1) && ((c = (a = o)[0]), (u = a[1]), (d = a[2]), (l = (f = i)[0]), (s = f[1]), (b = f[2])),
              isNaN(c) || isNaN(l)
                ? isNaN(c)
                  ? isNaN(l)
                    ? (g = Number.NaN)
                    : ((g = l), (1 != d && 0 != d) || "hsv" == n || (p = s))
                  : ((g = c), (1 != b && 0 != b) || "hsv" == n || (p = u))
                : (g = c + r * (l > c && l - c > 180 ? l - (c + 360) : l < c && c - l > 180 ? l + 360 - c : l - c)),
              void 0 === p && (p = u + r * (s - u)),
              new h([g, p, d + r * (b - d)], n)
            );
          },
        ...
        var Vt = i.clip_rgb,
          ...
          er = function(e, t) {
            ...
            return (n[0] = Ht(n[0])), (n[1] = Ht(n[1])), (n[2] = Ht(n[2])), n[3] > 0.9999999 && (n[3] = 1), new h(Vt(n));
          },
          tr = i.type,
          rr = Math.pow,
          nr = function(e) {
            ...
            return (
              (_.classes = function(e) {
                if (null != e) {
                  if ("array" === tr(e)) (i = e), (a = [e[0], e[e.length - 1]]);
                  else {
                    var t = p.analyze(a);
              ...
              (_.correctLightness = function(e) {
                return (
                  ...
                  (y = d
                    ? function(e) {
                        for (var t = w(0, !0).lab()[0], r = w(1, !0).lab()[0], n = t > r, a = w(e, !0).lab()[0], f = t + (r - t) * e, o = a - f, i = 0, c = 1, l = 20; Math.abs(o) > 0.01 && l-- > 0; )
                          n && (o *= -1), o < 0 ? ((i = e), (e += 0.5 * (c - e))) : ((c = e), (e += 0.5 * (i - e))), (a = w(e, !0).lab()[0]), (o = a - f);
                        return e;
                      }
                    : function(e) {
                        return e;
              ...
              (_.colors = function(t, r) {
                ...
                if (0 === arguments.length) n = c.slice(0);
                  ...
                  e = [];
                  var l = [];
                  if (i && i.length > 2) for (var u = 1, s = i.length, d = 1 <= s; d ? u < s : u > s; d ? u++ : u--) l.push(0.5 * (i[u - 1] + i[u]));
                  else l = a;
                  n = l.map(function(e) {
                    return _(e);
                  });
        ...
        for (
          var lr = or,
            ...
            Gr = {
              cool: function() {
                return nr([p.hsl(180, 1, 0.9), p.hsl(250, 0.7, 0.4)]);
              },
              hot: function() {
        ...
        return (
          (p.average = function(e, t, r) {
            ...
            return (d /= n), new h(o, t).alpha(d > 0.99999 ? 1 : d, !0);
          }),
          (p.bezier = function(e) {
            var t = fr(e);
            return (
          ...
          (p.blend = lr),
          (p.cubehelix = function(e, t, r, n, a) {
            void 0 === e && (e = 300), void 0 === t && (t = -1.5), void 0 === r && (r = 1), void 0 === n && (n = 1), void 0 === a && (a = [0, 1]);
            var f,
              o = 0;
            "array" === ur(a) ? (f = a[1] - a[0]) : ((f = 0), (a = [a, a]));
            var i = function(i) {
              var c = dr * ((e + 120) / 360 + t * i),
                l = hr(a[0] + f * i, n),
                u = ((0 !== o ? r[0] + i * o : r) * l * (1 - l)) / 2,
                s = pr(c),
                d = br(c);
              return p(sr([255 * (l + u * (-0.14861 * s + 1.78277 * d)), 255 * (l + u * (-0.29227 * s - 0.90649 * d)), 255 * (l + u * (1.97294 * s)), 1]));
            };
            return (
              (i.start = function(t) {
          ...
          (p.deltaE = function(e, t, r, n) {
            ...
            for (
              var a = Array.from(e.lab()),
                ...
                d = Nr(o * o + i * i),
                b = Nr(u * u + s * s),
                p = f < 16 ? 0.511 : (0.040975 * f) / (1 + 0.01765 * f),
                g = (0.0638 * d) / (1 + 0.0131 * d) + 0.638,
                v = d < 1e-6 ? 0 : (180 * Sr(i, o)) / Er;
              v < 0;

            )
              v += 360;
            for (; v >= 360; ) v -= 360;
            var y = v >= 164 && v <= 345 ? 0.56 + Pr(0.2 * Ar((Er * (v + 168)) / 180)) : 0.36 + Pr(0.4 * Ar((Er * (v + 35)) / 180)),
              m = d * d * d * d,
              w = Nr(m / (m + 1900)),
              k = g * (w * y + 1 - w),
              _ = d - b,
  ...
  class m {
    constructor(e, t, r) {
      b(this, "_toSVG", (e, t, r = {}) => {
        const n = e,
          a = { includeNamespace: !0, coordinateDecimals: 1, ...r },
          { points: f, opts: o, polys: i } = this,
          { width: c, height: l } = o,
        ...
        return n("svg", { xmlns: a.includeNamespace ? "http://www.w3.org/2000/svg" : void 0, width: c, height: l }, s, t);
      }),
        b(this, "toSVGTree", e => this._toSVG(y, null, e)),
        b(this, "toSVG", p ? (e, t) => this._toSVG(v, e, t) : (e, t) => this.toSVGTree(t)),
        b(this, "toCanvas", (e, t = {}) => {
          const r = { ...{ scaling: !!p && "auto", applyCssScaling: !!p }, ...t },
            { points: n, polys: a, opts: f } = this,
            o = e || ((i = f.width), (c = f.height), Object.assign(document.createElement("canvas"), { width: i, height: c }));
          var i, c;
          ...
          if (r.scaling) {
            const e =
              "auto" === r.scaling
                ...
                : r.scaling;
            1 !== e
              ? ((o.width = f.width * e), (o.height = f.height * e), r.applyCssScaling && ((o.style.width = f.width + "px"), (o.style.height = f.height + "px")))
              : ((o.width = f.width), (o.height = f.height), r.applyCssScaling && ((o.style.width = ""), (o.style.height = ""))),
              l.scale(e, e);
          }
          const u = (e, t, r) => {
            ...
            (l.lineJoin = "round"),
              l.beginPath(),
              l.moveTo(n[a[0]][0], n[a[0]][1]),
              l.lineTo(n[a[1]][0], n[a[1]][1]),
              l.lineTo(n[a[2]][0], n[a[2]][1]),
              l.closePath(),
              t && ((l.fillStyle = t.color.css()), l.fill()),
              r && ((l.strokeStyle = r.color.css()), (l.lineWidth = r.width), l.stroke());
          };
          return (
            f.fill && f.strokeWidth < 1 && a.forEach(e => u(e, null, { color: e.color, width: 2 })),
            a.forEach(e => u(e, f.fill && { color: e.color }, f.strokeWidth > 0 && { color: e.color, width: f.strokeWidth })),
            o
          );
        }),
        (this.points = e),
  ...
  const k = (e = 0.5) => ({ xPercent: t, yPercent: r, xScale: n, yScale: a, opts: f }) => d.mix(n(t), a(r), e, f.colorSpace);
  var _ = Object.freeze({
    __proto__: null,
    interpolateLinear: k,
  ...
  function x(e = {}) {
    ...
    const s = w(t.seed ? t.seed + 42 : null),
      h = [];
    for (let e = 0; e < u.length; e += 3) {
      const r = [u[e], u[e + 1], u[e + 2]],
        n = r.map(e => l[e]),
        { width: a, height: f } = t,
        o = e => Math.max(0, Math.min(1, e)),
        d = { x: ((b = n)[0][0] + b[1][0] + b[2][0]) / 3, y: (b[0][1] + b[1][1] + b[2][1]) / 3 },
        p = o(d.x / a),
        g = o(d.y / f),
        v = t.colorFunction({ centroid: d, xPercent: p, yPercent: g, vertexIndices: r, vertices: n, xScale: i, yScale: c, points: l, opts: t, random: s });
  ...
  const N = (e, t) => {
    const { width: r, height: n, cellSize: a, variance: f } = e,
      o = Math.floor(r / a) + 4,
      i = Math.floor(n / a) + 4,
      c = (o * a - r) / 2,
      l = (i * a - n) / 2,
